...
The solver uses a discretization based on a mesh and finite difference methods to numerically approximate the solution of reaction-diffusion problems. The arguments of the `solve` method give different options for how to do this:
